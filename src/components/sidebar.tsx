  ...
  return (
    <aside className="shrink-0 border-r py-0 px-[clamp(16px,2vw,32px)] sticky top-0 self-start min-h-screen" style={{ width: "clamp(140px,14vw,220px)" }}>
      <div className="flex flex-col">
        ...
        <div className="dash-ink mb-10" />
        <div className="flex flex-col uppercase font-sora tracking-wide" style={{ fontSize: "clamp(10px,1vw,14px)" }}>
          <a href="https://cinemaemsp.substack.com" target="_blank" rel="noopener noreferrer" className="group hover:text-accent transition-colors flex items-center gap-2.5 font-medium mb-8">
            ...
            SUBSTACK <svg width="8" height="8" viewBox="0 0 8 8" fill="none" className="tracking-wide w-2 h-2 inline stroke-[#23211D] group-hover:stroke-[#A52323] transition-colors">
          ...
          <a href="https://instagram.com/cinemaemsp" target="_blank" rel="noopener noreferrer" className="tracking-wide group hover:text-accent transition-colors flex items-center gap-2.5 font-medium mb-8">
          ...
          <a href="mailto:cinemaemsaopaulo@gmail.com" className="group hover:text-accent transition-colors flex items-center gap-2.5 font-medium mb-10">
